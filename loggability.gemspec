# -*- encoding: utf-8 -*-
# stub: loggability 0.12.0.pre20161214121603 ruby lib

Gem::Specification.new do |s|
  s.name = "loggability".freeze
  s.version = "0.12.0.pre20161214121603"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<configurability>.freeze, ["~> 2.0"])
      ...
      s.add_dependency(%q<configurability>.freeze, ["~> 2.0"])
